...
def cifar10(args):
    ...
    train_dataset = CIFAR10Instance(root="F:\\contrast-11\\HCSC\\data_visdrone2019", transform=augmentation, download=False)
    eval_dataset = CIFAR10Instance(root="F:\\contrast-11\\HCSC\\data_visdrone2019", transform=eval_augmentation, download=False)
    if args.distributed:
