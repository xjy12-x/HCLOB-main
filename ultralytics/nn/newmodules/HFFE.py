...
def autopad(k, p=None, d=1):  # kernel, padding, dilation
    ...
    if d > 1:
        ...
        )  # actual kernel-size                                                                     #来自Ai缝合怪复现整理
    if p is None:
...
if __name__ == "__main__":
    ...
    # 输出结果的形状
    # 打印输入和输出的形状
    print("Ai缝合怪即插即用模块永久更新-HFFE_input_size:", input1.size())
    print("Ai缝合怪即插即用模块永久更新-HFFE_output_size:", output.size())
    print("有关HFFE的二次创新，会更新在顶会顶刊二次创新改进交流群！")
    # SPHLFF 是TGRS 2025 HFFE 的二次创新模块,在二次创新交流群！
