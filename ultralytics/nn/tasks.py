...
from ultralytics.nn.newmodules.RCSAB import (
    RCSAB,
    C3k2_CRCSAB,
    C3k2_DRCSAB,
    C3k2_DSA,
...
from ultralytics.nn.newmodules.SCM import SCEU, Shift_channel_mix, SPConv
...
def parse_model(d, ch, verbose=True):
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in base_modules:
            ...
            c1 = ch[f]
            args = [c1, c2, *args[1:]]
        elif m is EBlock or m is DynamicSpatialAttention:
            ...
            args = [ch[f]]
            c2 = ch[f[-1]]
        elif m is SDPFusion or m is MKPConv or m is RCSAB or m is DTAB or m is GCSA or m is RLAB:
            c1 = ch[f] if isinstance(f, int) else ch[f[0]]
            c2 = make_divisible(args[0] * width, 8) if args else c1
            args = [c2]
        # elif m in {EFC}:
