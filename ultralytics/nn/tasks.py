...
from ultralytics.nn.newmodules.AAFM import AAFM
from ultralytics.nn.newmodules.BAM import BAMBlock
from ultralytics.nn.newmodules.CASAB import CASAB
from ultralytics.nn.newmodules.CMEA import C3k2_CMEA
from ultralytics.nn.newmodules.CVIM import CVIM
from ultralytics.nn.newmodules.DPCF import DPCF
from ultralytics.nn.newmodules.DRM import DRM
from ultralytics.nn.newmodules.DTAB import DTAB, GCSA
from ultralytics.nn.newmodules.EFC import EFC, MSEF
from ultralytics.nn.newmodules.FDConv import  FDConv
from ultralytics.nn.newmodules.FEM import FEM, SCAM
from ultralytics.nn.newmodules.FFM import FCM, FeatureFusion
from ultralytics.nn.newmodules.GBConv import GBConv, GSConv
from ultralytics.nn.newmodules.GCAM import C3k2_GCAM
from ultralytics.nn.newmodules.GCDB import C3k2_GCDB
from ultralytics.nn.newmodules.GCEB import C3k2_GCEB
from ultralytics.nn.newmodules.GLFA import C3k2_GLFA

from ultralytics.nn.newmodules.GMM import GMM
from ultralytics.nn.newmodules.GSA import Group_shuffle_Attention
from ultralytics.nn.newmodules.HDP import SDPFusion
from ultralytics.nn.newmodules.HFFE import HFFE
from ultralytics.nn.newmodules.HLFAE import C3k2_HLFAE
from ultralytics.nn.newmodules.KSFA import KSFA
from ultralytics.nn.newmodules.LEG import LEG
from ultralytics.nn.newmodules.LKLGL import LKLGL
from ultralytics.nn.newmodules.LWGA import LWGA
from ultralytics.nn.newmodules.MA import Multipole_Attention, MultipoleBlock
from ultralytics.nn.newmodules.MALA import MALA
from ultralytics.nn.newmodules.MHDA import MHDA
from ultralytics.nn.newmodules.MKDA import C3k2_MKDA
from ultralytics.nn.newmodules.MKP import C3k2_FCM, MKPConv
from ultralytics.nn.newmodules.MRFAConv import MRFAConv
from ultralytics.nn.newmodules.MSA import MSA
from ultralytics.nn.newmodules.MSAM import MSAM
from ultralytics.nn.newmodules.MSCA import GCBAM, MSCA
from ultralytics.nn.newmodules.MSEA import C3k2_MSEA
from ultralytics.nn.newmodules.PCAA import PCAA
from ultralytics.nn.newmodules.PLA import PolaLinearAttention
from ultralytics.nn.newmodules.RCSAB import RCSAB, C3k2_CRCSAB, C3k2_DRCSAB, C3k2_DSA, C3k2_HLRCSAB, C3k2_RCSAB, DynamicSpatialAttention
from ultralytics.nn.newmodules.RLAB import RLAB
from ultralytics.nn.newmodules.SAA import DSCGA, SAA, SCGA
from ultralytics.nn.newmodules.SBSAtt import SBSAtt
from ultralytics.nn.newmodules.DarkIR import EBlock
from ultralytics.nn.newmodules.SCM import SCEU, SPConv, Shift_channel_mix
from ultralytics.nn.newmodules.SCSPA import C3k2_SCSPA
from ultralytics.nn.newmodules.SOD import Add, DynamicScalSeq, ScalSeq, Zoom_cat, asf_attention_model
from ultralytics.nn.newmodules.SSA import MSCSA
from ultralytics.nn.newmodules.WNET import GSB, LSB_down_or_up
from ultralytics.nn.newmodules.converse2D import Converse2D
    ...
    base_modules = frozenset(
        {
            ...
            C3x,RepC3,PSA,SCDown,C2fCIB,C3k2_GCDB,C3k2_GCEB,C3k2_SCSPA,C3k2_CMEA,C3k2_GCAM, C3k2_GLFA, C3k2_HLFAE,C3k2_MKDA, C3k2_MSEA ,FDConv, GBConv,C3k2_FCM,
            GSConv,FDConv, C3k2_RCSAB, C3k2_DSA,C3k2_HLRCSAB,SPConv,GSB,LSB_down_or_up,MSA,DPCF,Multipole_Attention,C3k2_CRCSAB,C3k2_DRCSAB,
        }
    )
    repeat_modules = frozenset(  # modules with 'repeat' arguments
        {
           BottleneckCSP,C1,C2,C2f,C3k2,C2fAttn,C3,C3TR,C3Ghost,C3x,RepC3,C2fPSA,C2fCIB,C2PSA,C3k2_GCDB,C3k2_GCEB,C3k2_SCSPA,C3k2_CMEA, C3k2_GCAM,
                     C3k2_GLFA, C3k2_MKDA, C3k2_MSEA,FDConv, GBConv, GSConv, C3k2_FCM,C3k2_RCSAB, C3k2_DSA,C3k2_HLRCSAB,SPConv,GSB,LSB_down_or_up,MSA,DPCF,Multipole_Attention,C3k2_CRCSAB,C3k2_DRCSAB,
        }
    )
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in base_modules :
            ...
            args = [c1, c2, *args[1:]]
             ...
             c2 = make_divisible(args[0] * width, 8) if args else c1
             args = [c2]
        elif m is DynamicSpatialAttention:
             c1 = ch[f] if isinstance(f, int) else ch[f[0]]
             c2 = make_divisible(args[0] * width, 8) if args else c1
             args = [c2]
        elif m is SBSAtt:
        ...
        #     args = [ch[f[0]], ch[f[1]]]
            ...
            args = [ch[f[0]], ch[f[1]]]
             ...
             c2 = make_divisible(args[0] * width, 8) if args else c1
             args = [c2]
        elif m in (MHDA,LKLGL,AAFM,LWGA,CVIM,CASAB,MSCSA,PCAA,Shift_channel_mix,SCEU,Converse2D,MALA,MRFAConv,PolaLinearAttention,Group_shuffle_Attention,SAA,SCGA,FEM,EFC,MSEF,SCAM,FeatureFusion
                   ,FCM,GMM,MSCA,GCBAM,BAMBlock,DRM,KSFA,MultipoleBlock,DSCGA):
            c2 = ch[f]
            args = [c2, *args]#一个传参int问题，改此处        
